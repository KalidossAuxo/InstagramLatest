...
public class InstaPostWriteCommand implements Command<Void, ArrayList<Document>> {
...
public void insert(ArrayList<Document> documents) {
    if (documents != null && documents.size() != 0)
        SocialMediaPostDao.insertMany(documents, MovesConfiguration.COLLECTION_POSTS_INSTAGRAM);
}
}
