...
public class InstaAccountInsightsFetchCommand implements Command<ArrayList<Document>, String> {

    public InstaAccountInsightsFetchCommand() {
    }
    ...
    private ArrayList<Document> getAccountInsights(String accountId) {
        ...
        String url = String.format(Constants.INSTAGRAM_ACCOUNT_INSIGHTS, accountId);
        try {
